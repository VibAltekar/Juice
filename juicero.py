...
def textback(text):
    ...
    return True
#app.run(debug=True) TO ADD IN MAIN FUNCTION
def IP_Address():
...
def scraper():
    ...
    for i in juices:
        r  = requests.get("https://www.juicero.com/the-packs/"+ i + "/")
    return False
#twilio account info. (commented out because on Github)
ACCOUNT_SID = '#####'
AUTH_TOKEN = '######'
TWILIO_NUMBER = "#####"
MYNUMBER = "######"
...
class NutritionCounter:
    ...
    def proteins(self,nutrition,amount):
        ...
        perc = float((100*float(amount)/float(NutritionCounter.dailyProtein)))
        percv = format(perc, '.2f')
    ...
    def fats(self,nutrition,amount):
        ...
        perc = float((100*float(amount)/float(NutritionCounter.dailyFats)))
        percv = format(perc, '.2f')
    ...
    def calories(self):
        print("and how many calories was that? ")
        amount = input()
        try:
            int(amount)
        except:
        ...
        perc = float((100*float(amount)/float(NutritionCounter.dailyCalories)))
        percv = format(perc, '.2f')
    ...
    def __init__(self):
        ...
        while True:
            ...
            try:
                ...
                print("you didnt enter an amount")
                amount = input()
